...
export const REKU_CLIENT_RULE_VERSION =
  'reku-web-trade-734b58cded9e0058+sha256-f70980ea71240a3c9abeb080fb8707fd065714a24b8986a73fc04094634a943b';
...
function withEvidence(rule: IncrementRule): IncrementRule {
  return {
    ...rule,
    ...evidence,
    verifiedAt: rule.state === 'VERIFIED' ? evidence.capturedAt : undefined,
  };
}
