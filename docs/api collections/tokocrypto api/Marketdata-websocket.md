...
Connection management and real-time public market-data streams.
...
3.  Get a depth snapshot from **[https://www.tokocrypto.site/api/v3/depth?symbol=BNBBTC&limit=1000](https://www.tokocrypto.site/api/v3/depth?symbol=BNBBTC&limit=1000)** .
